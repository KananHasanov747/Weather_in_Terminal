...
if __name__ == "__main__":
    ...
    parser.add_argument ('ids', type = str, nargs = '?', metavar = '', action = 'store', default = '') # first argument

    parser.add_argument ('-rd', type = str, metavar = '', action = 'store', default = 'decoded', help = '') # second argument

    parser.add_argument ('-m', type = str, metavar = '', action = 'store', default = 'on', help = 'Include METAR (METeorological Aerodrome Report): "on" or "off"') # third argument
